...
public class CalculatorView extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jContentPane.add(getButtonPlus(), gridBagConstraints14);
			jContentPane.add(getButtonMin(), gridBagConstraints21);
			jContentPane.add(getButton0(), gridBagConstraints32);
			jContentPane.add(getButtonMaal(), gridBagConstraints41);
			jContentPane.add(getButtonClear(), gridBagConstraints51);
		}
		return jContentPane;
	}
...
} // @jve:decl-index=0:visual-constraint="68,23"
